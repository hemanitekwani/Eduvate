...
const Mathematics = () => {
  ...
  useEffect(() => {
    fetch( 'https://opentdb.com/api.php?amount=40&category=19')
  ...
  return (
    <View style={[styles.container, { backgroundColor: 'black' }]}>
      ...
      <Text style={{ fontWeight: 'bold', textAlign: 'center', marginTop: 40, fontSize: 30, color: 'white' }}> Welcome to Mathematics Quiz!</Text>
