...
const politicsScreen = () => {
  ...
  useEffect(() => {
    fetch('https://opentdb.com/api.php?amount=30&category=24')
  ...
  return (
    <View style={[styles.container, { backgroundColor: 'black' }]}>
      ...
      <Text style={{ fontWeight: 'bold', textAlign: 'center', marginTop: 40, fontSize: 30, color: 'white' }}> Welcome to Politics Quiz!</Text>
