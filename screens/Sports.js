...
const SportsScreen = () => {
    ...
    useEffect(()=> {
      fetch('https://opentdb.com/api.php?amount=30&category=21')
    ...
    const handleNextQuestion = () => {
      ...
      <Text style={{ fontWeight: 'bold', textAlign: 'center', marginTop: 40, fontSize: 30, color: 'white' }}> Welcome to Sports Quiz!</Text>
